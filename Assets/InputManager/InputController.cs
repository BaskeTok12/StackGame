...
public partial class @InputController : IInputActionCollection2, IDisposable
{
    ...
    public struct PlayerInteractionsActions
    {
        ...
        public void SetCallbacks(IPlayerInteractionsActions instance)
        {
            ...
            {
                @Click.started -= m_Wrapper.m_PlayerInteractionsActionsCallbackInterface.OnClick;
                @Click.performed -= m_Wrapper.m_PlayerInteractionsActionsCallbackInterface.OnClick;
                @Click.canceled -= m_Wrapper.m_PlayerInteractionsActionsCallbackInterface.OnClick;
            }
